...
//     await dbClient!.update(habitTableName, habitModel,
//         where: 'id=?', whereArgs: [habitModel.dbKey]);
//     await dbClient.update(
//         repetitionTableName, habitModel.repetition!.habitModel.dbKey,
//         where: 'dbId=?', whereArgs: [habitModel.dbKey]);
//     habitModel.repetition!.weekdays!.forEach((element) async {
//       await dbClient.update(weekdayTableName, element.habitModel.dbKey,
...
//           await dbClient?.insert(
//               activityTable,
//               Activities(date: dateTime.toIso8601String(), habitId: model.dbKey)
//                   .toDbJson());
//         } else {
